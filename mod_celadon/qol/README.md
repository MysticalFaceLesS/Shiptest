...
Карго
- REMOVE `code\modules\cargo\packs\machinery.dm` Перемещён Robotics crate в `D:\1ss\ShiptestYata\mod_celadon\cargo_items\code\space_idea.dm`, на более видное место, дополнил деталями для сборки ботов и инструкции по сборке
