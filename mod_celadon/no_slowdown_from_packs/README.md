...
ID мода: CELADON_NO_SLOWDOWN_FROM_PACKS
<!--
...
Этот мод убирает замедление персонажа при ношении синдидюффеля которое было установлено оффами.
<!--
...
<!--
  ...
  Примеры: `code/__defines/~mod_celadon/no_slowdown_from_packs.dm`: `NO_SLOWDOWN_FROM_PACKS_SPEED_MULTIPLIER`, `NO_SLOWDOWN_FROM_PACKS_SPEED_BASE`
-->
