...
/datum/modpack/no_slowdown_from_packs
	name = "Без замедления на синдидюффели"
	desc = "Убирает замедление при ношении синдидюффелей"
	author = "Quinal"
...
// Инициализация ДО
/datum/modpack/no_slowdown_from_packs/pre_initialize()
	. = ..()

// Инициализация ВОВРЕМЯ
/datum/modpack/no_slowdown_from_packs/initialize()
	. = ..()

// Инициализация ПОСЛЕ
/datum/modpack/no_slowdown_from_packs/post_initialize()
	. = ..()
