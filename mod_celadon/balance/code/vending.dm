...
/obj/machinery/vending/medical/ship_edition
    name = "\improper NanomedPlus SE"
    all_items_free = TRUE

/obj/machinery/vending/medical/syndicate_access/ship_edition
    name = "\improper SyndiMedPlus SE"
    all_items_free = TRUE
