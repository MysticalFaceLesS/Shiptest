...
Этот мод служит для возможного добавления оутфита для учёных Киберсана.
<!--
...
<!--
  ...
  Примеры: `code/__defines/~mod_celadon/outfit_syndicate_cybercun_research.dm`: `OUTFIT_SYNDICATE_CYBERCUN_RESEARCH_SPEED_MULTIPLIER`, `OUTFIT_SYNDICATE_CYBERCUN_RESEARCH_SPEED_BASE`
-->
