...
/mob/living/basic/netguardian
	...
	icon = 'mod_celadon/_storge_icons/icons/mobs/netguardian.dmi'
...
/datum/action/cooldown/mob_cooldown/projectile_attack/rapid_fire/netguardian
	...
	button_icon = 'mod_celadon/_storge_icons/icons/items/obj/netguardian_ammo.dmi'
...
/datum/action/cooldown/mob_cooldown/projectile_attack/rapid_fire/netguardian/Activate(atom/target_atom)
	...
	playsound(player, 'mod_celadon/_storge_sounds/sound/effects/skyfall_power_up.ogg', 120)
	player.say("target acquired.", "machine")

	var/overlay_icon = 'mod_celadon/_storge_icons/icons/mobs/netguardian.dmi'
