...
Этот мод содержит временно удаленные из кода объекты и куски кода нуждающиеся в переработке и которые в текущем виде могут приносить все больше багов.
<!--
...
- REMOVE: `code/game/objects/items/circuitboards/machine_circuitboards.dm` : вырезаем каргопад, требуется переработка
...
<!--
  ...
  Примеры: `code/__defines/~mod_celadon/shit_spawn.dm`: `SHIT_SPAWN_SPEED_MULTIPLIER`, `SHIT_SPAWN_SPEED_BASE`
-->
