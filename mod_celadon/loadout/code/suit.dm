...
// 		Cloaks
//********************
/datum/gear/accessory/suit/hooded/cloak/tajaran
	subtype_path = /datum/gear/accessory/suit/hooded/cloak/tajaran

/datum/gear/accessory/suit/hooded/cloak/tajaran/gruff
	display_name = "gruff cloak"
	description = "A cloak designated for the lowest classes."
...
/datum/gear/accessory/suit/hooded/cloak/tajaran/amohda
	display_name = "amohdan cloak"
	description = "Originally used by the Amohdan swordsmen before the First Revolution, this cloak is now commonly worn by the island population."
...
/datum/gear/suit/costumes
	subtype_path = /datum/gear/suit/costumes
...
/datum/gear/suit/costumes/soviet
...
/datum/gear/suit/costumes/deckers
