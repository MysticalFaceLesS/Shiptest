...
/datum/species/vulp/get_hair_list_by_gender(gender)
	return GLOB.vulp_hairs_list

/datum/species/vulp/get_facial_hair_list_by_gender(gender)
	return GLOB.vulp_facial_hairs_list

/datum/species/vulp/random_hairstyle(gender)
	return pick(GLOB.vulp_hairs_list)

/datum/species/vulp/random_facial_hairstyle(gender)
	return pick(GLOB.vulp_facial_hairs_list)
