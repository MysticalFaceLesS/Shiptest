...
Добавляет риг лп уборщика и карту.
<!--
...
- `icons/obj/clothing/head/spacesuits.dmi`
- `icons/mob/clothing/head/spacesuits.dmi`
- `icons/obj/clothing/suits/spacesuits.dmi`
- `icons/mob/clothing/suits/spacesuits.dmi`
- `icons/obj/card.dmi`
<!--
