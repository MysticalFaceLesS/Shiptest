...
/mob/living/carbon/human/dummy/consistent/proc/seeded_randomization(seed = 0, species_list = null)
	...
	dna.features["tajara_ears"] = GLOB.tajara_ears_list[seed % length(GLOB.tajara_ears_list) + 1]
	dna.features["tajara_hairs"] = GLOB.tajara_hairs_list[seed % length(GLOB.tajara_hairs_list) + 1]
	dna.features["tajara_ears_markings"] = GLOB.tajara_ears_markings_list[seed % length(GLOB.tajara_ears_markings_list) + 1]
	dna.features["tajara_head_markings"] = GLOB.tajara_head_markings_list[seed % length(GLOB.tajara_head_markings_list) + 1]
	dna.features["tajara_nose_markings"] = GLOB.tajara_nose_markings_list[seed % length(GLOB.tajara_nose_markings_list) + 1]
	dna.features["tajara_facial_hairs"] = GLOB.tajara_facial_hairs_list[seed % length(GLOB.tajara_facial_hairs_list) + 1]
	dna.features["tajara_chest_markings"] = GLOB.tajara_chest_markings_list[seed % length(GLOB.tajara_chest_markings_list) + 1]
	dna.features["tajara_body_markings"] = GLOB.tajara_body_markings_list[seed % length(GLOB.tajara_body_markings_list) + 1]
	dna.features["tajara_tail"] = GLOB.tajara_tail_list[seed % length(GLOB.tajara_tail_list) + 1]
