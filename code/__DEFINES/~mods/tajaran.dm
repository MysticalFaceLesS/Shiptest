...
#define TAJARA_MASK_PATH 'mod_celadon/tajara/icons/clothing/onmob_mask_tajaran'
#define TAJARA_HEAD_PATH 'mod_celadon/tajara/icons/clothing/onmob_head_tajaran'
#define TAJARA_SUIT_PATH 'mod_celadon/tajara/icons/clothing/onmob_suit_tajaran'
